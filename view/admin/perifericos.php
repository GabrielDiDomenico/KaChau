...
<div class="ps-container pt-90"> 
  <div class="ps-section__header">
    <h2 class="ps-section__title" data-mask="Cadastro">- Perifericos</h2>
  </div>
  <div class="row mb-80">
  ...
  <div class="tabela mb-80">
    ...
    <div class="row">
      ...
      <center>fetch_peri_thumb</center>
      </div>	
      <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="background-color: #cccccc; padding: 5px;">
      <center>fetch_peri_name</center>
      </div>
      <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="background-color: #cccccc; padding: 5px;">
      <center>fetch_peri_cat</center>
      </div>
      <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="background-color: #cccccc; padding: 5px;">  
      <center>fetch_peri_status</center>
      </div>
