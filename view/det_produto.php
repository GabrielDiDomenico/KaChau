          ...
          <div class="row">
            <div class="col-lg-10 col-md-12 col-lg-offset-1">
              ...
              <div class="ps-product__info">
                ...
                <h1>Placa de Vídeo Gigabyte NVIDIA GeForce RTX 3060 Ti, 8GB, GAMING OC PRO - GV-N306TGAMINGOC PRO-8GD </h1>
                
                <h3 class="ps-product__price">R$ 4.764,59 <del>R$  5.764,59</del></h3>
                <div class="ps-product__block ps-product__quickview">
                  <h4>Breve Avaliação</h4>
                  <p>lorem ipsum</p>
                </div>
                <div class="ps-product__block ps-product__style">
                  <h4><a href="#">Clique aqui e Compare com outros Modelos</a></h4>
              ...
              <div class="ps-product__content mt-50">
                ...
                <li class="active"><a href="#tab_01" aria-controls="tab_01" role="tab" data-toggle="tab">Sobre o produto</a></li>
                  <li ><a href="#tab_01" aria-controls="tab_01" role="tab" data-toggle="tab">Especificações</a></li>
                  <li><a href="#tab_02" aria-controls="tab_02" role="tab" data-toggle="tab">Avaliação</a></li>
                </ul>
              </div>
