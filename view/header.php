  ...
  <body class="ps-loading">
      ...
      <nav class="navigation">
        <div class="container-fluid">
          <div class="navigation__column left">
            <div class="header__logo"><a class="ps-logo" href="index.php"><img src="images/logoB.png" alt=""></a></div>
          </div>
          <div class="navigation__column center">
                <ul class="main-menu menu">
                  <li class="menu-item"><a href="index.php">Home</a></li>
                  <li class="menu-item menu-item-has-children dropdown"><a href="#">Peças</a>
                    <ul class="sub-menu">
                        <li class="menu-item"><a href="#">Peça 1</a></li>
                        <li class="menu-item"><a href="#">Peça 2</a></li>
                    </ul>
                  </li>
                  <li class="menu-item menu-item-has-children dropdown"><a href="#">Perifericos</a>
                    <ul class="sub-menu">
                        <li class="menu-item"><a href="#">Perifericos 1</a></li>
                        <li class="menu-item"><a href="#">Perifericos 2</a></li>
                    </ul>
                  </li>
                  <li class="menu-item"><a href="#">Gabinetes</a></li>
    ...
    <div class="header-services">
      <div class="ps-services owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="7000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="false" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on">
        <p class="ps-service"><i class="ps-icon-delivery"></i><strong>Frete Grátis</strong>: Ganhe frete grátis em qualquer compra acima de 200 reais para todo Brasil!</p>
        <p class="ps-service"><i class="ps-icon-delivery"></i><strong>Frete Grátis</strong>: Ganhe frete grátis em qualquer compra acima de 200 reais para todo Brasil!</p>
        <p class="ps-service"><i class="ps-icon-delivery"></i><strong>Frete Grátis</strong>: Ganhe frete grátis em qualquer compra acima de 200 reais para todo Brasil!</p>
      </div>
    </div>